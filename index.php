        ...
        <nav class="navbar navbar-expand-lg navbar-light navbar-custom1">
            <div class="container-fluid">
              ...
              <div class=" collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <form class="d-flex">
                    <button style=" font-size: 20px;" class="btn btn-outline-light l_R_B"><b>LOGIN</b></button>
                    <button style="margin-left: 15px;font-size: 20px;" class="btn btn-light l_R_B"><b>REGISTER</b> </button>
                </form>
              </div>
            </div>
          </nav>
